...
This chapter examines how the reference implementation interprets contact
...
concrete execution paths and the evidence needed to determine which, if any,
of the Provider-grant, credential-issuance, and message-acceptance boundaries
each inconsistency reaches.
