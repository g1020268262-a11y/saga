...
We call the end-to-end requirement \emph{policy--authorization consistency}:
every accepted access must be traceable to an applicable authorization decision.
For every execution and every accepted-access event $e$, we require
\[
...
fixed rulebook. Cryptographic checks are assumed effective. The authorization
inconsistency under study is a disagreement between policy meaning and enforcement during ordinary
